...
Install [scribe](https://jmbarbone.github.io/scribe/) from CRAN with:
...
You’ll probably use [scribe](https://jmbarbone.github.io/scribe/) within
small scripts that can be called from your favorite terminal. The
example below uses a function to call this file, but if it is added to
your `PATH` you’d be able to call it directly:
...
I’ve been using [scribe](https://jmbarbone.github.io/scribe/) for some
personal scripts. Below is a short list of some examples (mostly in my
